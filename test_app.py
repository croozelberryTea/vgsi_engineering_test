...
class TestApp(unittest.TestCase):
    ...
    def test_get_houses_by_id_01(self):
        ...
        self.assertEqual(
            data, x
        )  # hard coded this test, for this example it works fine tho
    ...
    def test_put_houses_by_id_01(self):
        ...
        res = self.app.put(
            GOOD_ITEM_URL, data=json.dumps(edit), content_type="application/json"
        )
        data = json.loads(res.get_data().decode("utf-8"))
        self.assertEqual(res.status_code, 200)
    ...
    def test_put_houses_by_id_03(self):
        ...
        res = self.app.put(
            ADD_ITEM_URL, data=json.dumps(edit), content_type="application/json"
        )
        data = json.loads(res.get_data().decode("utf-8"))
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data, edit)
